...
export const CASH_REFUND_ELIGIBILITY_NOTICE =
  "실제 보유 중인 유상 캐시 잔액에 한해 환불 가능하며, 무상 캐시·쿠폰·이벤트 지급분은 환불되지 않습니다.";
export const CASH_REFUND_ORIGINAL_METHOD_NOTICE =
  "환불은 원칙적으로 캐시 충전 시 사용한 결제수단으로 진행됩니다.";
export const CASH_VALIDITY_NOTICE =
  "여러 건의 충전 내역이 있는 경우, 환불 가능한 충전 건을 기준으로 최근 충전 건부터 순차적으로 취소 또는 환불 처리됩니다.";
export const CASH_REFUND_SCHEDULE_NOTICE =
  "환불은 신청 즉시 충전 시 사용한 결제수단으로 취소 요청됩니다.";
export const CASH_REFUND_HOLIDAY_NOTICE =
  "다만 실제 취소 완료 또는 환불 금액 반영까지는 결제수단 및 카드사·은행 사정에 따라 영업일 기준 3~5일이 소요될 수 있습니다.";
export const CASH_REFUND_CUTOFF_NOTICE =
  "캐시를 일부 사용한 후 잔여분을 환불하는 경우에도 실제 환불 가능 잔액 범위 내에서 처리됩니다.";
...
export const REFUND_POLICY_SECTIONS: RefundPolicySection[] = [
  {
    ...
    groups: [
      ...
      },
      {
        title: "참가자 미달 기준",
        rows: [
          { condition: "참가자 미달(1)", policy: "3vs3: 2명 이하 / 4vs4: 3명 이하 / 5vs5: 4명 이하" },
          { condition: "참가자 미달(2)", policy: "3vs3: 4명 이하 / 4vs4: 5명 이하 / 5vs5: 6명 이하" },
        ],
      },
      {
        title: "그 외 취소 기준",
        items: [
          "취소 수수료 발생 시 사용된 캐시를 우선 차감 후 차액을 캐시로 지급합니다.",
    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          ...
          "매치 시작 2시간 내 시간당 1mm 이상 강수 예보가 발생하면 '강수 예보 변동 안내' 알림톡이 발송됩니다. 이 경우, 현장 방문 후 매니저에게 취소 의사를 전달하면 다음 날 오전 전액 캐시 환불됩니다.",
          ...
          "현장에서 강수로 인해 매치가 취소되거나 중단되면 진행하지 못한 시간만큼 캐시로 환불됩니다.",
        ],
      },
    ],
  },
  {
    ...
    title: "충전 캐시 환불",
    description:
      "충전 캐시의 환불 방법, 환불 가능 조건, 원결제수단 취소 처리 기준을 확인할 수 있습니다.",
    groups: [
      {
        title: "환불 방법",
        items: [
